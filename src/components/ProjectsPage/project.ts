...
let projects : ProjectData[] = [
    {
        ...
        desc: "This portfolio webpage was made by me. It is a responsive website that changes for smaller screens. This can be tested in the browser by making the browser narrower. The webpage also includes a dark mode that can be tested by clicking in the top right corner.",
        time: "2021 Feb"
    },
    {
        title: "StochSD",
